...
- **UI-F2** ✅ done — `GET /activities/records` + `/activities/stats?since=&category=&include_strength=` + ytd `months`; period row, PR card and week/month grouping on both surfaces, sort/grid on web.
