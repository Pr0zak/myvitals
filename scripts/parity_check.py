...
PAIRS: list[tuple[str, str, str]] = [
    ...
    ("frontend/src/components/VitalTiles.vue",
     "android/app/src/main/kotlin/app/myvitals/ui/common/VitalTiles.kt",
     "Vitals tiles — status pill, sparkline, staleness"),
    ("frontend/src/components/ReadinessHero.vue",
     "android/app/src/main/kotlin/app/myvitals/ui/neon/ReadinessHero.kt",
     "Readiness hero — band, drivers, formula sheet"),
