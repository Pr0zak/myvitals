...
def register_jobs(scheduler: AsyncIOScheduler) -> None:
    ...
    # Strava OAuth scheduled poll DISABLED as of v0.7.275.
    #
    # Strava's June 2026 policy paywalls Standard-Tier API access on
    # 2026-06-30 for existing developers without a paid subscription.
    # Running a scheduled poller after that date would log 401s every
    # tick. The replacement is cookie-session ingest (SCS family),
    # button-triggered via /strava/cookie-sync from Settings + the
    # Activities header. OAuth endpoints stay registered for users
    # who pay for the subscription and want to re-enable it manually.
